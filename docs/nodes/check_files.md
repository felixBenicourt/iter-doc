...
The **Check Files** node is used to verify the existence of a given file or folder. It checks whether the path provided in the attribute exists, which can be useful for validating input paths before further processing.

---

### Parameters

- **Attribute**: The name of the attribute containing the path to the file or folder you want to check.
