...
The **Transfert Key** node is used to copy attributes and their values from one node to another. It works by looping through the attributes and transferring the attribute name to the corresponding value. This node is particularly useful when you want to transfer both the attributes and their values between different nodes in the graph.

---

### Parameters

- **Attributes**: This parameter defines the loop over the attributes and transfers the attribute names to the corresponding values.
