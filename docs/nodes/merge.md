...
The **Merge Node** combines attributes and their values from multiple sources into a unified stream. It merges the flux of nodes and branches, enabling seamless integration of different data streams in the node graph.
