...
The **Rename Key Node** allows you to rename an attribute in the main flux. This node provides an easy way to modify the name of an existing attribute without affecting its value. It's useful when you want to update attribute names dynamically within your node-based workflow.

---

### Parameters

- **Current Name**: The current name of the attribute that you wish to rename.
- **New Name**: The new name to assign to the chosen attribute.
