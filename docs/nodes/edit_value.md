...
The **Edit Value Node** enables you to modify the value of a specific attribute in the stream. By specifying the attribute and the portion of the value to replace, you can seamlessly update data in the flux.
...
- **Top Input**: Main flux.
- **Bottom Input**: New value to replace the existing one based on the attribute name.

---

### Parameters

- **Attribute**: The name of the attribute you want to edit.
- **Current Value**: The portion of the current value you want to replace.
