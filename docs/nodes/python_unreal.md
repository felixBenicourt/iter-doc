...
The **Python Unreal Node** executes a Python script within the Unreal Engine scene. It allows you to apply custom Python scripts to manipulate the Unreal scene based on the provided input data.
...
- **path**: The path to the Unreal scene where you want to apply your Python script.

---

### Usage

- You can manipulate the scene's data within the Python script by using the variable `input_data`.
- Write custom Python code to process or modify the Unreal scene based on the provided flux and attributes.
