...
The **Echo Stream Attributes Node** returns the stream of attributes using the `calcAttributes()` method. This node is useful for verifying or debugging the attributes flowing through the node graph.
