...
The **Read File** node is used to load a file path as an attribute. This allows you to work with file paths dynamically within the node graph and perform further operations based on the file's location.

---

### Parameters

- **Attribute name**: The name of the attribute that will hold the file path.
