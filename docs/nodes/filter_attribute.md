...
The **Filter Attribute Node** filters the stream of attributes, retaining only the specified attribute and its corresponding value.
...
- **Attribute Name**: The name of the attribute you want to retain in the stream.
