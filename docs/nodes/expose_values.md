...
The **Expose Values Node** generates attributes and their corresponding values from a dictionary key, enabling you to dynamically create and manipulate stream data.
...
- **Attribute Name**: The name of the attribute to be created.
